...
public class KeyGenerator {
    ...
    public KeyGenerator() throws IOException {
        ...
        BufferedReader readInf = new BufferedReader(new FileReader("J.txt"));
        ...
        BigInteger x;
        try {
            x = jj.modPow(ss, n).modInverse(n);
        } catch (ArithmeticException except){
            System.out.println("There is no inverse element for " + jj.modPow(ss, n) + " modulo " + n);
            return;
        }
